...
export const USER_DELETE_RESET = "USER_UPDATE_PROFILE_RESET";
...
export const USER_COUPON_REQUEST = "USER_COUPON_REQUEST";
export const USER_COUPON_SUCCESS = "USER_COUPON_SUCCESS";
export const USER_COUPON_FAIL = "USER_COUPON_FAIL";
